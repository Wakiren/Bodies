...
public:
	...
	bool DrawUIimage(SDL_Texture* texture, int x, int y, float scale = 1 ,const SDL_Rect* section = NULL, float speed = 1.0f, double angle = 0, int pivotX = INT_MAX, int pivotY = INT_MAX) const;
